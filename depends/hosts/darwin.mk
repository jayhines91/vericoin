...
# Ubuntu 22.04+ ships a host /usr/bin/ld that breaks macOS cross-links unless we
# explicitly select the cctools ld64 shim from depends' native toolchain.
darwin_LDFLAGS=-fuse-ld=$(build_prefix)/bin/$(host)-ld
