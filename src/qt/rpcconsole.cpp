    ...
    platformStyle(_platformStyle)
{
    ...
    ui->openDebugLogfileButton->setToolTip(ui->openDebugLogfileButton->toolTip().arg(GUIUtil::GetCoinName()));
...
void RPCConsole::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the %1 RPC console.").arg(GUIUtil::GetCoinName()) + "<br>" +
...
QKeySequence RPCConsole::tabShortcut(TabTypes tab_type) const
{
    ...
    case TabTypes::ACTIVITY: return QKeySequence(Qt::CTRL + Qt::Key_A);
